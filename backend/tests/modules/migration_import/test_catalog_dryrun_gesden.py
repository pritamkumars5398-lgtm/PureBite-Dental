...
GESDEN_ROWS: list[dict] = [
    ...
    {
        "codigo": "0001", "agd": "OBTUR. COMP.",
        "med": "Obturación composite", "tipo_odg": 22,
        "expect": "link", "expect_code": "REST-COMP",
    },
    {
        "codigo": "0002", "agd": "OBT. AMALG.",
        "med": "Obturación amalgama", "tipo_odg": 22,
        "expect": "link", "expect_code": "REST-AMAL",
    },
    {
        "codigo": "0003", "agd": "OBT TEMP",
        "med": "Obturación temporal", "tipo_odg": 22,
        "expect": "link", "expect_code": "REST-TEMP",
    },
    # ── Coronas (alias MC, ZIRC) ──
    {
        "codigo": "0010", "agd": "CORONA MC",
        "med": "Corona metal-cerámica", "tipo_odg": 26,
        "expect": "link", "expect_code": "REST-CROWN-MC",
    },
    {
        "codigo": "0011", "agd": "CORONA ZIRC",
        "med": "Corona zirconio", "tipo_odg": 26,
        "expect": "link", "expect_code": "REST-CROWN-ZIR",
    },
    {
        "codigo": "0012", "agd": "CORONA PROV",
        "med": "Corona provisional", "tipo_odg": 26,
        "expect": "link", "expect_code": "REST-CROWN-PROV",
    },
    # ── Puentes (multi-tooth) ──
    {
        "codigo": "0020", "agd": "PUENTE MC",
        "med": "Puente metal-cerámica", "tipo_odg": 27,
        "expect": "link", "expect_code": "REST-BRIDGE-MC",
    },
    # ── Carillas ──
    {
        "codigo": "0030", "agd": "CARILLA PORC",
        "med": "Carilla porcelana", "tipo_odg": 33,
        "expect": "link", "expect_code": "REST-VEN-PORC",
    },
    # ── Endodoncia (alias UNI, BI, MOLAR) ──
    {
        "codigo": "0040", "agd": "ENDO UNI",
        "med": "Endodoncia unirradicular", "tipo_odg": 21,
        "expect": "link", "expect_code": "ENDO-UNI",
    },
    {
        "codigo": "0041", "agd": "ENDO BI",
        "med": "Endodoncia birradicular", "tipo_odg": 21,
        "expect": "link", "expect_code": "ENDO-BI",
    },
    {
        "codigo": "0042", "agd": "ENDO MOLAR",
        "med": "Endodoncia molar", "tipo_odg": 21,
        "expect": "link", "expect_code": "ENDO-MULTI",
    },
    # ── Pernos ──
    {
        "codigo": "0050", "agd": "PERNO FIBRA",
        "med": "Perno de fibra", "tipo_odg": 25,
        "expect": "link", "expect_code": "ENDO-POST-FIBER",
    },
    # ── Cirugía: extracciones ──
    {
        "codigo": "0060", "agd": "EXT SIMPLE",
        "med": "Extracción simple", "tipo_odg": 37,
        "expect": "link", "expect_code": "SURG-EXT-SIMPLE",
    },
    {
        "codigo": "0061", "agd": "EXT 3 MOLAR",
        "med": "Extracción tercer molar", "tipo_odg": 37,
        "expect": "link", "expect_code": "SURG-EXT-3MOLAR",
    },
    {
        "codigo": "0062", "agd": "EXTRACCION PIEZA INCLUIDA",
        "med": "Extracción de pieza incluida", "tipo_odg": 37,
        "expect": "link", "expect_code": "SURG-EXT-INCLUIDO",
    },
    # ── Implantes ──
    {
        "codigo": "0070", "agd": "IMPL TI",
        "med": "Implante de titanio", "tipo_odg": 24,
        "expect": "link", "expect_code": "SURG-IMP-TI",
    },
    {
        "codigo": "0071", "agd": "IMPL ZIRC",
        "med": "Implante de zirconio", "tipo_odg": 24,
        "expect": "link", "expect_code": "SURG-IMP-ZIR",
    },
    {
        "codigo": "0072", "agd": "APICEC.",
        "med": "Apicectomía", "tipo_odg": 23,
        "expect": "link", "expect_code": "SURG-APEC",
    },
    # ── Preventivo / higiene ──
    {
        "codigo": "0080", "agd": "LIMPIEZA DENTAL",
        "med": "Limpieza dental", "tipo_odg": 38,
        "expect": "link", "expect_code": "PREV-CLEAN",
    },
    {
        "codigo": "0081", "agd": "FLUOR",
        "med": "Fluorización", "tipo_odg": 41,
        "expect": "link", "expect_code": "PREV-FLUOR",
    },
    {
        "codigo": "0082", "agd": "SELLADOR FOSAS",
        "med": "Sellador de fosas y fisuras", "tipo_odg": 32,
        "expect": "link", "expect_code": "PREV-SEAL",
    },
    # ── Ortodoncia ──
    {
        "codigo": "0090", "agd": "BRACKET INDIVIDUAL",
        "med": "Bracket individual", "tipo_odg": 8,
        "expect": "link", "expect_code": "ORTO-BRACK",
    },
    {
        "codigo": "0091", "agd": "ORTO METAL",
        "med": "Ortodoncia brackets metálicos", "tipo_odg": 8,
        "expect": "link", "expect_code": "ORTO-METAL",
    },
    {
        "codigo": "0092", "agd": "RETENEDOR FIJO",
        "med": "Retenedor fijo", "tipo_odg": 8,
        "expect": "link", "expect_code": "ORTO-RET-FIX",
    },
    # ── Diagnóstico ──
    {
        "codigo": "0100", "agd": "PRIMERA VISITA",
        "med": "Primera visita", "tipo_odg": 13,
        "expect": "link", "expect_code": "DX-VISIT",
    },
    {
        "codigo": "0101", "agd": "RX PAN",
        "med": "Radiografía panorámica", "tipo_odg": 39,
        "expect": "link", "expect_code": "DX-RXPAN",
    },
    {
        "codigo": "0102", "agd": "RX PERIAPICAL",
        "med": "Radiografía periapical", "tipo_odg": 39,
        "expect": "link", "expect_code": "DX-RXPA",
    },
    # ── Gesdén-only que NO existe en seed: debe crear en su categoría ──
    {
        "codigo": "0200", "agd": "TTO ESPECIAL DR X",
        "med": "Tratamiento especial Dr X (composite avanzado)", "tipo_odg": 22,
        "expect": "create", "expect_category": "restauradora",
    },
    {
        "codigo": "0201", "agd": "ANOTACION COL",
        "med": "Anotación colaborador", "tipo_odg": 11,
        "expect": "create", "expect_category": "migrado_gesden",
    },
    {
        "codigo": "0202", "agd": "BONO JUNIO",
        "med": "Bono de junio", "tipo_odg": 14,
        "expect": "create", "expect_category": "migrado_gesden",
    },
]
